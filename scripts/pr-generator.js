...
class PRGenerator {
  ...
  generatePRBody(changes, figmaFileUrl = '') {
    ...
    body += `| Type | Count |\n`;
    body += `|------|-------|\n`;
    if (added > 0) body += `| ✨ Added tokens | ${added} |\n`;
    if (modified > 0) body += `| 🔄 Modified tokens | ${modified} |\n`;
    if (removed > 0) body += `| 🗑️ Removed tokens | ${removed} |\n`;
    ...
    body += `---\n`;
    body += `🤖 This PR was generated by Figma Variables auto-sync.`;
