...
class ColorSemanticMonoWhite implements ColorSemanticTheme {
  const ColorSemanticMonoWhite._();

  static ColorSemanticMonoWhite? _instance;

  static ColorSemanticMonoWhite get instance 
    => _instance ??= const ColorSemanticMonoWhite._();
