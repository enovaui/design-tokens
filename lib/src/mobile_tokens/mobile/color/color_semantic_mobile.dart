...
class ColorSemanticMobile implements ColorSemanticTheme {
  const ColorSemanticMobile._();

  static ColorSemanticMobile? _instance;

  static ColorSemanticMobile get instance =>
     _instance ??= const ColorSemanticMobile._();
