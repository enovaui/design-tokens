...
test('moible mono-white tokens HTML renders and matches screenshot', async ({ page }) => {
  ...
  await expect(page).toHaveScreenshot('reference-color-mobile-mono-white-tockens.png', {threshold: 0.2});
});
