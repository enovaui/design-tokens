...
test('moible brand tokens HTML renders and matches screenshot', async ({ page }) => {
  ...
  await expect(page).toHaveScreenshot('reference-color-mobile-brand-tockens.png', {threshold: 0.2});
});
