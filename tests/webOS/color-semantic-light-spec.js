...
test('webOS ligth tokens HTML renders and matches screenshot', async ({ page }) => {
  ...
  await expect(page).toHaveScreenshot('reference-color-webos-light-tockens.png', {threshold: 0.2});
});
