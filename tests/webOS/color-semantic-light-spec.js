...
test('webOS light tokens HTML renders and matches screenshot', async ({ page }) => {
  ...
  await expect(page).toHaveScreenshot('reference-color-semantic-light-tokens.png', {threshold: 0.2});
});
